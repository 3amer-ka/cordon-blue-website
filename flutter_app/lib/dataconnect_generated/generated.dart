...
class ExampleConnector {
  CreateInquiryVariablesBuilder createInquiry({
    required String name,
    required String email,
    required String message,
  }) {
    return CreateInquiryVariablesBuilder(
      dataConnect,
      name: name,
      email: email,
      message: message,
  ...
  UpdateProjectStatusVariablesBuilder updateProjectStatus({
    required String id,
    required String status,
  }) {
    return UpdateProjectStatusVariablesBuilder(
      dataConnect,
      id: id,
      status: status,
    );
