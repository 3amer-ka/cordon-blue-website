...
class CreateInquiryVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  CreateInquiryVariablesBuilder phoneNumber(String? t) {
  ...
  CreateInquiryVariablesBuilder(this._dataConnect, {required  this.name,required  this.email,required  this.message,});
  ...
  MutationRef<CreateInquiryData, CreateInquiryVariables> ref() {
    CreateInquiryVariables vars= CreateInquiryVariables(name: name,email: email,message: message,phoneNumber: _phoneNumber,subject: _subject,);
...
class CreateInquiryInquiryInsert {
  ...
  bool operator ==(Object other) {
    ...
    final CreateInquiryInquiryInsert otherTyped = other as CreateInquiryInquiryInsert;
...
class CreateInquiryVariables {
  ...
  @override
  int get hashCode => Object.hashAll([name.hashCode, email.hashCode, message.hashCode, phoneNumber.hashCode, subject.hashCode]);
