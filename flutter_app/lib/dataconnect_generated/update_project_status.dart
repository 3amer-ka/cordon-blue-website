...
class UpdateProjectStatusProjectUpdate {
  ...
  UpdateProjectStatusProjectUpdate({required this.id});
}
...
class UpdateProjectStatusData {
  ...
  UpdateProjectStatusData({this.projectUpdate});
}
...
class UpdateProjectStatusVariables {
  ...
  UpdateProjectStatusVariables({required this.id, required this.status});
}
