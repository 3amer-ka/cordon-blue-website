...
async function runTests() {
    ...
    try {
        ...
        let activeLinks = mainHeader.querySelectorAll('nav a.text-primary:not(#mobile-menu a)');
        ...
        activeLinks = mainHeader.querySelectorAll('nav a.text-primary:not(#mobile-menu a)');
        assert.strictEqual(activeLinks.length, 1, "There should be exactly 1 active link");
