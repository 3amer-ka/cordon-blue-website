...
class TestOptimizeHotelResort(unittest.TestCase):
    ...
    def test_image_mode_conversion_rgba(self, mock_path_join, mock_open):
        ...
        mock_converted.save.assert_called_once_with('./test_dir/base.jpg', 'JPEG', quality=80)

        # 2 webp saves on resized, 1 jpg save on converted
        self.assertEqual(mock_resized.save.call_count, 2)
